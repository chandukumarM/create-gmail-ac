...
<a href="https://www.google.co.in/?gfe_rd=cr&dcr=0&ei=rwd8Wo2OAq6H8QeO5KPYAQ"><img id="brand"class="img-responsive" src="images/brandd.png" alt="logo"></a>
  </div>
  <div id="btn1"class="col-md-1 col-sm-1">
<a style="color:#fff" href="https://accounts.google.com/SignUp?hl=en"><button class="btn-responsive" id="btn" type="button" name="button">Sign in</button></a>
  </div>
</div>
...
<div class="form-horizontal row">
  ...
  <div class="dropdown col-md-3" id="vbr">
    ...
    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu" id="bbba">
...
<span class="caret"></span>
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu" style=""id="ccca">
                        <li data-value="1"><a class="a" href="#"> <img class="ind" src="images/in.svg" alt="">India </a></li>
  <li role="presentation" class="divider"></li>
                        <li data-value="2"><a class="a" href="#"> <img class="ind" src="images/us.svg" alt="">America </a></li>
                        <li data-value="3"><a class="a" href="#"> <img class="ind" src="images/nz.svg" alt="">Newziland</a></li>
                        <li data-value="4"><a  class="a"href="#"><img class="ind" src="images/sl.svg" alt="">Sierra Leone </a></li>
                    </ul>
                </div>
...
<br>  <input type="text" name="" id="cemail" onfocus="ce()" onfocusout="ce2()" data-toggle="popover"  data-content="please enter your current email address(Optional) " data-placement="left">
<span id="cemail_error" style="color:red;display:none">you can't leave this empty</span> <br>
<label for="">Location</label>
<br>
<select class="col-md-9" id="dfd"  data-toggle="popover"  data-content="Select your country " data-placement="left">
    <option>India</option>
     <option>Us</option>
  ...
  <div class="col-md-offset-9"id="next">
    <button type="submit" name="button" id="bttt" >Next step</button>
  </div>
